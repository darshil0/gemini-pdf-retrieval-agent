...
export const ErrorMessages = {
  ...
  SEARCH_TIMEOUT:
    'The search took too long and was cancelled. Please try with fewer documents or a simpler query.',
  SEARCH_PARSE_FAILED:
    'Failed to parse the AI response. The response was not valid JSON.',
  ...
  FILE_STREAM_TIMEOUT:
    'File processing timed out. The file may be too large or corrupted.',

  // PDF viewer errors
  PDF_LOAD_FAILED:
    'Failed to load the PDF document. The file may be corrupted or in an unsupported format.',
  PDF_WORKER_FAILED:
    'Failed to initialize PDF rendering engine. Please refresh the page.',
