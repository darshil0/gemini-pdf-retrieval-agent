...
- **LICENSE File** - Added a `LICENSE` file with the MIT license text.

### Fixed

- **Markdown File Casing** - Standardized the casing of all markdown files to be consistent.
- **Unnecessary Files** - Removed unnecessary documentation files from the `docs` directory.
